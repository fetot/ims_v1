...
<div class="row">
	<div class="col-md-12">
		...
		<ol class="breadcrumb">
		  ...
		  <li class="active">Stock Penunjang</li>
		</ol>

		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Stock Penunjang</div>
			</div> <!-- /panel-heading -->
...
<script src="custom/js/productpenunjang.js"></script>
